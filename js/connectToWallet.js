...
async function getContract() {
    if (window.ethereum) {
        contractAddress = "0x9f70d4b4a1dd183dae5239d85ec570339ebd9492";
        try {
...
async function getData(address) {
   await getContract();
	...
	res1.innerHTML = "<span class=\"value\">"+(Math.round(addressDividends*10000)/10000) + " BUSD </span> in dividends paid to this address";
	
	let res2 = document.getElementById("res2")
	for(let i = 0; i<18; i++){
		totalDividends = totalDividends/10
	}
	res2.innerHTML = "<span class=\"value\">"+(Math.round(totalDividends*100)/100) + " BUSD </span> in dividends paid in total";
